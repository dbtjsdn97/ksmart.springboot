...
public class GoodsController {
	...
	public String insertGoods(@RequestParam(name = "memberLevel", required = false, defaultValue = "4") int memberLevel 
							,Goods goods) {
		System.out.println("상품 등록 화면" + goods);
		System.out.println("상품 등록 화면에서 입력 받은 값" + memberLevel);
		
		if(memberLevel < 3) {
			// 상품등록
			String result = goodsService.insertGoods(goods);
			System.out.println("상품 등록 하기"+ result);
